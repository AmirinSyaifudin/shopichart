...
<div class="container">
    ...
    <div class="box">
        <div class="box-header">
                ...
                <a href="{{ route('admin.produk.index') }}" class="btn btn-danger">KEMBALI KE PRODUK</a>
            </div>
            <div class="box-body">
                ...
                <table id="" class="table table-dark">
                    ...
                    <tbody>
                        <tr>
                            <td width='200'><img class="profile-user-img img-responsive img-big" src="{{url('/assets/covers/'. $produk->cover)}}"> </td>
                            <td scope="row"> {{ $produk->nama_produk }}</td>
                    ...
                    <table id="" class="table table-dark">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"> {{ $produk->qty }}</th>
                                <td scope="row"> {{ 'Rp.'. number_format ($produk->harga) . "  " }} </td>
...
{{--  !-- /.box-header -->
    <div class="box">
        <div class="box-header">
                <h3 class="box-title">DATA DETAIL PRODUK</h3><br><br>
                <a href="" class="btn btn-primary">KEMBALI KE PRODUK</a>
            </div>
            <div class="box-body">
...
{{--
<table id="" class="table table-bordered table-dark">
    <thead>
        <tr>
            <th width='20'>PHOTO</th>
            <th width='5'>NAMA BARANG</th>
    ...
    <tbody>
        <tr>
            <td width='50'> {{ $produk->cover }} </td>
            <td width='20'> {{ $produk->nama_produk }} </td>
            <td width='20'> {{ $produk->katagori_id }} </td>
            </tr>
    </tbody>
</table>
...
<table id="" class="table table-bordered table-dark">
    ...
    <tbody>
        <tr>
            <td width='50'> {{ $produk->keterangan }} </td>
            <td width='5'>  {{ $produk->qty }} </td>
            <td width='20'> {{ 'Rp.'. number_format ($produk->harga) . "  " }}</td>
...
<table id="" class="table table-bordered table-dark">
    ...
    <tbody>
        <tr>
            <td width='20'> {{ 'Rp.'. number_format ($produk->harga * $produk->qty) . "  " }}</td>
            <td width='20'> </td>
            </tr>
    </tbody>
</table>  --}}
