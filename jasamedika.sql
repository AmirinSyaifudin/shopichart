...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Bulan Mei 2020 pada 09.41
...
(5, '2020_05_12_063001_create_kelurahan_table', 1),
(6, '2020_05_12_063554_create_pasien_table', 1);
...
(1, 'Amir Sy', 'amirinsyaifudin6@gmail.com', NULL, '$2y$10$urzeBQ6gXB70cjy7nUTZnOnku5iaVha3dkiWqX0RR1UE3clyFWCzK', NULL, '2020-05-11 23:42:12', '2020-05-11 23:42:12');
...
ALTER TABLE `pasien`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pasien_kelurahan_id_foreign` (`kelurahan_id`);
...
--
ALTER TABLE `pasien`
  ADD CONSTRAINT `pasien_kelurahan_id_foreign` FOREIGN KEY (`kelurahan_id`) REFERENCES `kelurahan` (`id`) ON UPDATE CASCADE;
